...
<html lang="en">
  ...
  <body id="page-top">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav text-uppercase ml-auto">
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#services">Instructions</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#portfolio">Planning an Event</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#about">Calendar</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#Hello">Test</a>
            </li>
            <li class="nav-item">
    ...
    <header class="masthead">
      <div class="container">
        <div class="intro-text">
          <div class="intro-lead-in">Welcome to ________________</div>
          <div class="intro-heading text-uppercase"> MM-DD-YYYY</div>
    ...
    <!-- Planning Event -->
        ...
        <div class="row">
          <script type="text/javascript" src="https://form.jotform.com/jsform/80330405140136"></script>
        </div>
      </div>
    </section>
    ...
    <!-- Team -->
    <section class="bg-light" id="Hello">
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
